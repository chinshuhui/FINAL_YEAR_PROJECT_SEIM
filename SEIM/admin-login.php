  ...
  $password = mysql_real_escape_string($_POST['password']);
    if(empty($username) || empty($password)){
        ...
        if(mysql_num_rows($query1)>0){
          ...
          $message="Nama pengguna dan kata laluan tidak tepat";
        }
      }
  }
 ?>
...
<html>
  ...
  <div class="animated fadeIn">
    ...
    <svg fill="#fff" height="148" viewBox="0 0 24 24" width="148" xmlns="http://www.w3.org/2000/svg" class="shad">
      ...
      <div class="padd">
        ...
        <div class="col-lg-12 text-center">
              <form class="" method="post" autocomplete="off">
                ...
                <input type="text" name="username" placeholder="Nama Pengguna Admin" id="email">
                <br><br>
      ...
      <div class="links">
        <a href="dummy-login.php">Jurutera </a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php">Pengguna </a>
      </div>
  </div>
      <?php
      include 'footer.php';
