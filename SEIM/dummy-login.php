  ...
  $password =  mysql_real_escape_string($_POST['password']);
    if(empty($name) || empty($password)){
        ...
        if(mysql_num_rows($query1)>0){
          ...
          $message="Nama / kata laluan adalah tidak tepat";
        }
      }
  }
 ?>
...
<html>
  <head>
    ...
    <title>LOG MASUK JURUTEKNIK  </title>
    ...
    <svg fill="#fff" height="148" viewBox="0 0 24 24" width="148" xmlns="http://www.w3.org/2000/svg" class="shad">
      ...
      <div class="padd">
        <div class="col-lg-12 text-center">
              ...
              <br>
              Belum Mempunyai Akaun ? <a href="dummy-register.php">Daftar Akaun</a>
        </div>
      </div>
      <div class="links">
        <a href="index.php">Pengguna </a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin-login.php">Admin </a>
      </div>
  </div>
    <?php
    include 'footer.php';
