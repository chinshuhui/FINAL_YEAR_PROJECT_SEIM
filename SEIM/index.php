  ...
  $password = mysql_real_escape_string($_POST['password']);
    if(empty($email) || empty($password)){
        ...
        if(mysql_num_rows($query1)>0){
          ...
          $message="Nama pengguna / kata laluan adalah tidak tepat";
        }
      }
  }
 ?>
...
<html>
  ...
  <body >
    ...
    <div class="cover user text-center">
      ...
      <h2>Sistem E-Aduan ICT Majlis Agama Islam Negeri Kedah Darul Aman (MAIK)</h2>
    </div>
      ...
      <div class="padd">
        ...
        <div class="col-lg-12 text-center">
              <form class="" method="post" autocomplete="off">
                ...
                <input type="email" name="email" placeholder="Emel" id="email">
                <br><br>
                <label for="password"></label>
                <input type="password" name="password" placeholder="Kata Laluan" id="pass">
                <br><br>
                <button type="submit" class="log">LOG MASUK</button>
                <br><br>
                <span class="red"><?php echo $message; ?></span>
              </form>
              <br>
                Belum Ada Akaun? <a href="signup.php">Daftar Akaun  </a>

        </div>
      </div>

      <div class="links">
        <a href="dummy-login.php">Juruteknik</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin-login.php">Admin </a>
      </div>
