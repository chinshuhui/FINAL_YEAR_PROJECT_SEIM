  ...
  <div class="cover main">
    ...
    <div class="div">
        <div class="col-lg-12 ">
          ...
          <?php
          echo "<a class='button logout' href ='m_delete.php?id=$id' onClick=\"javascript:return confirm ('Adakah anda ingin memadam aduan tersebut ?');\">Padam</a>";
           ?>
          ...
          <?php
            ...
            while( $arry=mysql_fetch_array($query1) ) {
              ...
              $ref = $arry['ref_no'];
               ...
               echo "<tr> <td> <b> No Telefon</b> </td>";
               echo "   <td> ".$phone_no."</td> </tr>";

               echo "<tr> <td> <b> Tajuk Aduan</b> </td>";
               echo "   <td> ".$subject."</td> </tr>";

               echo "<tr> <td> <b> Butiran Aduan</b> </td>";
               echo "   <td> ".$complain."</td></tr>";

               echo "<tr> <td> <b> Rujukan</b> </td>";
               echo "   <td> ".$ref."</td></tr>";
          ?>
          </table>
          ...
          <div class="field-off jumbotron">
            <br>
            <h2>Jurutera berkenaan</h2>
            <p>Nota : Klil pada jurutera yang berkenaan untuk menyelesaikan masalah tersebut </p>
