<?php
 ...
 <html>
   ...
   <div class="div">
     ...
     ?>
     <h2>Anda sedang mengemukakan aduan ini kepada <?php echo $name ; ?></h2>
      <br><br>
   ...
   if(($status)==46){
     $query = mysql_query("SELECT ref_no FROM `view_cmp` WHERE ref_no=$ref");
       if (mysql_num_rows($query) != 0){
           #$message =  "Aduan ini telah dikemukakan kepada Jurutera yang berkenaan";
         ...
         <div class ='text-right' id='close'>
          ...
          <p>Aduan ini telah berjaya dikemukakan kepada Jurutera yang berkenaan</p>
         </div>";
         ...
         <svg class='pointer' fill='#FFF' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'>
           ...
           <p class='text-center'>Aduan ini telah berjaya dikemukakan kepada Jurutera yang berkenaan</p>
         </div> </div>";
       }
   }else{
          $message = "<div class='alert errr' id='msg'>
          ...
          <svg class='pointer' fill='#FFF' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'>
            ...
            <p class='text-center'>Aduan Tidak Dapat Dikemukakan !!</p>
          </div> </div>";
     }
 }
 ?>
