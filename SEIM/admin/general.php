      ...
      if(isset($_POST['update']))
      {
        ...
        if(empty($name) || empty($username) || empty($password)){
          ...
          <div class ='text-right' id='close'>
           ...
           <p>Pilih Nama, Nama Pengguna Dan Kata laluan !!</p>
          </div>";
        }else{
            ...
            <div class='alert succ' id='msg'>
              <div class ='text-right' id='close'>
                ...
                <p class='text-center'>Butiran anda telah dikemaskini.</p>
              </div>
            </div>
            ";
          }
    ...
    <div class="div">
          <div class = "col-lg-12">
            <form class="" action="" method="post" autocomplete="off">
              ...
              <table>
                  <tr>
                      <td><h4>Kemaskini data anda</h4><br><br></td>
                  </tr>
                  <tr>
                    <td>Kemaskini terkini pada :</td>
                  ...
                  <tr>
                    <td></td>
                    <td><button name="update" type="submit" class="log">Simpan</button></td>
                  </tr>
              </form>
              <?php
                    }
