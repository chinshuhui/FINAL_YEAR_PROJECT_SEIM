...
<html>
  ...
  <div class="animated fadeIn">
    ...
    <div class="cover main">
      <?php
      if (isset($_SESSION['username'])===true) {echo "<h1> Selamat Datang, ".$_SESSION['username']."</h1>";}
       ?>
       <a class="button logout" href="../logout.php" onClick="javascript:return confirm ('Adakah anda ingin log keluar akaun anda ?');"> Log Keluar </a>
       &nbsp;&nbsp;&nbsp;
      ...
      <div class="col-lg-12">
          <div class="analysis">
            ...
            <div class="track theme">
                Jumlah Pengguna <br> <p><?php echo $count_users;?></p>
            </div>

            <div class="track vio">
                Jumlah Juruteknik <br> <p><?php echo $count_engi;?></p>
            </div>
          ...
          <br><br>
            ...
            $new_eng=$name3['name'];
             ...
             <div class="content">
               <div class="div_data">Pengguna Baru</div>
               <div class="div_data">Aduan Baru Daripada</div>
               <div class="div_data">Juruteknik Baru </div>
             </div>
